...
function getUserIdFromAuth(req) {
    // Dual-mode: an Express request carries a plain headers object, a Web/Next
    // Request carries a Headers instance. Supporting both is what lets server.js
    // and the Next route handlers share this file untouched during the migration.
